package com.waheguru.helloworld;

import com.waheguru.helloworld.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "waheguru.com", ownerName = "waheguru.com", packagePath = "helloworld"))
